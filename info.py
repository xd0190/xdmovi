...
PICS = (environ.get('PICS', 'https://graph.org/file/c449975691597e1792ff2.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001717761625').split()]
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'c3b157a2c510112c243e9c85d0c322d5278d3409')
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'earn2me.com')
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'c3b157a2c510112c243e9c85d0c322d5278d3409')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True ))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/nawab_me0')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/nawabbotupdate')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/nawabbotupdate/68')
...
#Direct Link Generator By @abmoviehouse
DIRECT_GEN_DB = int(environ.get("DIRECT_GEN_DB", "-1001842448946")) # Enter your channel id
DIRECT_GEN_URL = environ.get("DIRECT_GEN_URL", "https://directdownload-029b49595d77.herokuapp.com/") # https://example.com/
